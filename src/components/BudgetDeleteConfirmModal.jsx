...
const BudgetDeleteConfirmModal = ({ isOpen, onClose, onConfirm, budget }) => {
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg max-w-md w-full p-6 fade-in">
        ...
        {budget && (
          <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-3 mb-6">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">
              <strong>Month:</strong> {new Date(budget.year, budget.month).toLocaleString('default', { month: 'long', year: 'numeric' })}
            </p>
          </div>
        )}
...
export default BudgetDeleteConfirmModal;